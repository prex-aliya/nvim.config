-- This is not all my work, these are the sources and there contributors
--
-- https://github.com/elianiva/dotfiles/blob/950ba38bda8230da8071fc72cf3d8617d6288565/config/nvim/lua/modules/statusline.lua
...
-- change them if you want to different separators
-- TODO(anon): add more seperators/text options
M.separators = {
  arrow       = { " ", " " },
  ascii       = { "> ", " <" },
  rounded     = { " ", " " },
...
-- To get the current mode {Insert, Visual, etc..}
